export const ERROR = {
  ...
  'ERRORS': {
    ...
    'FETCHING_MESSAGE_1': 'Nous rencontrons des problèmes lors de la récupération des données. Cela pourrait être à cause d\'un problème de connexion au serveur.'
  },
