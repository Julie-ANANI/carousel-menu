...
const DetectingNeedsHelp: PitchDescriptionHelp = {
  en: {
    ...
    issue: 'This part helps to contextualize and introduce the subject matter of the questionnaire to the professionals. <br>' +
      '1. Introduction<br>' +
  ...
  fr: {
    ...
    summary: 'Le pitch doit prendre la forme de deux phrases maximum mettant en lumière la proposition de valeur ' +
      'forte et différenciante du projet. Il sera présent dans le corps de texte des emails que nous enverrons aux professionnels.<br>',
    issue: 'Cette partie permet de contextualiser et d\'introduire la thématique du questionnaire aux professionnels. <br>' +
      '<br>' +
      '1. Introduction <br>' +
...
const ValidatingMarketHelp: PitchDescriptionHelp = {
  en: {
    ...
    issue: 'This part helps to contextualize and introduce the identified issues to the professionals.<br>' +
      '1. Introduction<br>' +
      'Introduce the subject matter / the market context.<br>' +
      '2. Wider issue<br>' +
    ...
    example: {
      ...
      issue: 'Fluid distribution networks (water, gas, industrial fluids) are mainly made up of plastic pipes. Whether to deploy, ' +
        ...
        'These failures may eventually result in leaks that compromise the safety of the system and have financial repercussions. <br>' +
        ...
        'the interface due to interference) and generate volumes of information that are difficult to process and interpret.<br>' +
  ...
  fr: {
    ...
    issue: 'Cette partie permet de contextualiser le questionnaire et d\'introduire les problématiques identifiées aux professionnels. <br>' +
      '1. Introduction <br>' +
      'Introduisez la thématique/ le contexte marché.<br>' +
...
const ValidatingInterestHelp: PitchDescriptionHelp = {
  en: {
    ...
    issue: 'This part helps to contextualize the questionnaire and to introduce the identified issues to the professionals. <br>' +
      '1. Introduction<br>' +
    ...
    example: {
      ...
      solution: 'We have developed a solution for on-site hydrogen production from natural gas. The hydrogen quality is at least equivalent to that produced from industrial sources (e.g. SMR)  (purity >99%).<br>' +
        'This on-site hydrogen solution offers the following advantages:<br>' +
        '1) Reduce costs<br>' +
        'On-site production with our unit is more cost-effective (15% lower than existing on-site solutions on average) than a supply ' +
  ...
  fr: {
    ...
    example: {
      ...
      solution: 'Nous avons développé une solution de production d’hydrogène sur site à partir de gaz naturel. L\'hydrogène généré est de ' +
        ...
        'Cette nouvelle solution de génération sur site émet 20% de moins de C02 par rapport aux solutions on-sites existantes.<br>' +
...
const DiscoveringApplicationsHelp: PitchDescriptionHelp = {
  en: {
    ...
    solution: 'This section is meant to describe your solution in terms of features, benefits to the user, properties and to ' +
      'address the issues identified in the "Issues" part. <br>' +
      '1. Solution<br>' +
      'Describe the solution.<br>' +
      '2. Main solved issue<br>' +
      'Explain how your solution solves the main issue.<br>' +
  ...
  fr: {
    ...
    issue: 'Cette partie permet de contextualiser le questionnaire et d\'introduire les problématiques identifiées aux professionnels. <br>' +
      ...
      'Introduisez le périmètre / la thématique et le contexte marché. <br>' +
      '2. Problématique générale <br>' +
      'Expliquez le principal point de douleur (si vous le connaissez).<br>' +
      '3. Problématiques des solutions actuelles <br>' +
      'Listez les solutions actuelles et expliquez en quoi elles ne répondent pas bien à cette problématique.',
    solution: 'Cette partie permet d\'expliquer votre solution en termes de fonctionnalités, de bénéfices d\'usage, ' +
      'de propriétés et de répondre aux problématiques identifées dans la partie "problématiques" <br>' +
    ...
    example: {
      ...
      solution: 'Notre solution consiste à mettre dans les dispositifs de production et de consommation de l\'énergie, notre système ' +
        ...
        'augmenter de plus de 30 % le taux de récupération de l’énergie, de 50 % l’autonomie et multiplier par 3 la durée de vie des ' +
        'batteries.<br>' +
...
const TargetingApplicationHelp: PitchDescriptionHelp = {
  en: {
    ...
    issue: 'This part helps to contextualize the questionnaire and to introduce the identified issues to the professionals. <br>' +
      '1. Introduction<br>' +
      'Introduce the scope / subject matter.<br>' +
      '2. Wider issue<br>' +
      'Outline the major pain point.<br>' +
      '3. Current solutions\' issues<br>' +
      'List the current solutions and expose why they\'re not relevant.',
  ...
  fr: {
    ...
    issue: 'Cette partie permet de contextualiser le questionnaire et d\'introduire les problématiques identifiées aux professionnels. <br>' +
      '1. Introduction <br>' +
      'Introduisez le périmètre / la thématique.<br>' +
      '2. Problématique générale <br>' +
      'Expliquez le principal point de douleur.<br>' +
      '3. Problématiques des solutions actuelles <br>' +
      'Listez les solutions actuelles et expliquez en quoi elles ne répondent pas bien à cette problématique.',
    ...
    example: {
      ...
      solution: 'Notre solution consiste à mettre dans les dispositifs de production et de consommation de l\'énergie, notre système ' +
        'intelligent de gestion de charge et décharge des batteries pilotant une configuration spécifique de celles-ci. <br>' +
        'Grâce à son IA, le système anticipe et optimise les consommations mais aussi les productions (solaire, thermiques) pour ' +
        'augmenter de plus de 30 % le taux de récupération de l’énergie, de 50 % l’autonomie et multiplier par 3 la durée de vie ' +
        'des batteries.<br>' +
        'Le système permet aussi la visualisation de l\'état de santé de la batterie sur les interfaces existantes des dispositifs ' +
        'et le temps efficace d\'utilisation pour une meilleure gestion des sources d\'énergie.  <br>' +
        'Notre écosystème de gestion intelligent de l’énergie s\'adapte sur tout type d\'applications aussi bien civiles que ' +
  ...
  fr: {
    ...
    example: {
      ...
      issue: 'Les alimentations de secours sont utilisées pour assurer le fonctionnement de certaines fonctions électroniques ' +
        'clés en cas de panne ou d\'arrêt de l\'alimentation principale. Leurs principales exigences dépendent de l\'application :<br>' +
  ...
  en: {
    ...
    example: {
      ...
      issue: 'Today, hydrogen production is centralized near large industrial areas. The supply arrives by truck, either ' +
        ...
        'far from the production centers. (it could represent up to 40% of the total H2 cost, depending on the geographical area).<br>' +
