...
import { AdminCampaignAvailablescenariosComponent } from './components/admin-campaigns/admin-campaign-availablescenarios/admin-campaign-availablescenarios';
// Pipes
...
@NgModule({
  ...
  declarations: [
    ...
    AdminCampaignAvailablescenariosComponent,
