...
@Component({
  ...
  templateUrl: './add-ambassador-form.component.html',
  styleUrls: ['./add-ambassador-form.component.scss']
})

export class AddAmbassadorFormComponent implements OnInit {

  @Input() set sidebarState(value: string) {
    if (value === undefined || 'active') {
      this.buildForm();
      this._ambassadorForm.reset();
  ...
  */
  ...
  private _ambassadorForm: FormGroup;
  ...
  get ambassadorForm(): FormGroup {
    return this._ambassadorForm;
  }
