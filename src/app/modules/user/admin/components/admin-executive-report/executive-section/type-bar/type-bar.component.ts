...
export class TypeBarComponent {
  ...
  public textColor(field: string, index?: number) {
    switch (field) {
      ...
      case 'legend':
        if (index === 1) {
          this._example1Color = CommonService.getLimitColor(this._content.values[0].legend.length, 40);
        } else if (index === 2) {
          this._example2Color = CommonService.getLimitColor(this._content.values[1].legend.length, 40);
        } else if (index === 3) {
          this._example3Color = CommonService.getLimitColor(this._content.values[2].legend.length, 40);
        }
        break;
