export const NEW_PROJECT = {
  ...
  'LEADS': {
    'LINE1': 'Accédez aux coordonnées complètes',
    'LINE2': 'Des offres spéciales sur vos marchés',
    'LINE3': 'Entrez en contact avec des prospects potentiels sur demande'
  }
