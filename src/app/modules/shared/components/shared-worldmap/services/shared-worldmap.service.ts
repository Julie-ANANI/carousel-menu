...
export class SharedWorldmapService {
  ...
  private _continentsList = this._translateService.currentLang === 'fr' ?
    ['africa', 'americaNord', 'americaSud', 'asia', 'europe', 'oceania'] :
  ...
  public areAllContinentChecked(selectedContinents: {[c: string]: boolean}): boolean {
    return this._continentsList.every((c) => selectedContinents[c] === true);
  }
