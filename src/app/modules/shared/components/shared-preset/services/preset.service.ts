...
export class PresetService {
  ...
  private taggedQuestionsTypes: {[identifier: string]: QuestionType} = {
    ...
    other_context: 'radio',
    other_isCritical: 'radio',
    other_criticalIssues: 'stars',
    other_otherIssues: 'textarea',
    other_solutions: 'textarea',
    other_relevance: 'radio',
    other_strengths: 'stars',
    other_weaknesses: 'textarea',
    other_useIt: 'radio',
    other_leads: 'checkbox',
    other_contact: 'textarea',
