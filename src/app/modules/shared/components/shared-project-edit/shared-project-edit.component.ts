...
@Component({
  selector: 'shared-client-project-edit',
  templateUrl: 'shared-project-edit.component.html',
  styleUrls: ['shared-project-edit.component.scss']
})
export class SharedProjectEditComponent implements OnInit, OnDestroy, ComponentCanDeactivate {
