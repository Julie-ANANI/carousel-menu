...
tinymce.PluginManager.add('variable', function(editor) {
    ...
    function createHTMLVariable( value ) {
        ...
        return '<span style="color:#0B90C6; background-color: #CCEBF8; padding: 4px 10px; font-size: 12px; border-radius: 3px; margin-left: 2px; margin-right: 4px; margin-bottom: 4px;" data-original-variable="' + variable + '" contenteditable="false">' + cleanMappedValue + '</span>';
    }
